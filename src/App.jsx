    ...
    <>
      ...
      {/* <div className="contact-footer">
        <div className="contact-icons">
          <a
            href="https://github.com/KapranchukTaras"
            target="_blank"
          ...
          <a
            href="https://www.linkedin.com/in/kapranchuk-taras-51041622a/"
            target="_blank"
            rel="noopener noreferrer"
          ...
          <a href="mailto:hrushdmytr@gmail.com" aria-label="Email Contact">
            <i className="fas fa-envelope"></i>
          </a>
          <a
            href="/Portfolio/CV/Kapranchuk Taras.pdf"
            target="_blank"
            rel="noopener noreferrer"
          >
